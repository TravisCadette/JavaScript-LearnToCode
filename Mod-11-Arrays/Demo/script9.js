...
// Search fiir the element whose id is specified 
let selectedElement = menu.find(arrayElement => arrayElement.id == 4); //find element whose id is 4
if(selectedElement != null) {
    console.group(selectedElement.item + " $" + selectedElement.price);
}
else {
    console.log("id #4 was not found");
}
